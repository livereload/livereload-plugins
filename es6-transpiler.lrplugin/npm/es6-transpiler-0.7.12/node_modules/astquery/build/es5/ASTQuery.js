...
//			, preudoSelectorsMap = this._preudoSelectorsMap
	...
	ASTQuery.prototype._collectCallbacks = function() {
...

		{
			...
			if ( group !== void 0 ) {
				if ( matchedCallbacks[group] ) {
					var callback, node, mods, defaultMod, self;$D$18 = (matchedCallbacks[group]);$D$15 = GET_ITER$0($D$18);$D$16 = $D$15 === 0;$D$17 = ($D$16 ? $D$18.length : void 0);for (  ; $D$16 ? ($D$15 < $D$17) : !($D$17 = $D$15["next"]())["done"]; ){;callback = (self = ($D$16 ? $D$18[$D$15++] : $D$17["value"])).callback, node = self.node, mods = self.mods, defaultMod = self.defaultMod, self = ((self = self.self) === void 0 ? null : self);
				...
				$D$15 = GET_ITER$0(matchedCallbacks);$D$16 = $D$15 === 0;$D$17 = ($D$16 ? matchedCallbacks.length : void 0);for ( var matchedCallbacksGroup ; $D$16 ? ($D$15 < $D$17) : !($D$17 = $D$15["next"]())["done"]; ){matchedCallbacksGroup = ($D$16 ? matchedCallbacks[$D$15++] : $D$17["value"]);
					var callback$0, node$0, mods$0, defaultMod$0, self$0;$D$21 = (matchedCallbacksGroup || []);$D$18 = GET_ITER$0($D$21);$D$19 = $D$18 === 0;$D$20 = ($D$19 ? $D$21.length : void 0);for (  ; $D$19 ? ($D$18 < $D$20) : !($D$20 = $D$18["next"]())["done"]; ){;callback$0 = (self$0 = ($D$19 ? $D$21[$D$18++] : $D$20["value"])).callback, node$0 = self$0.node, mods$0 = self$0.mods, defaultMod$0 = self$0.defaultMod, self$0 = ((self$0 = self$0.self) === void 0 ? null : self$0);
						if ( !mods$0 && !this.mods.length || mods$0 && this._isInMods.apply(this, [defaultMod$0].concat(ITER$0(mods$0))) ) {
							callback$0.call(self$0, node$0, this);
						}
	...
	ASTQuery.prototype.getAST = function(cleanup) {var cleanup = cleanup.cleanup;var this$0 = this;//TODO:: tests
		...
		if ( cleanup === true ) {
			...
			this.traverse(ast, function(node)  {
				...
				if ( !visitorKeysMap ) {
					visitorKeysMap = visitorKeysMaps[node.type] = this$0.visitorKeys[node.type].reduce( function(val, name)  {val[name] = null;return val}, {});
				}
