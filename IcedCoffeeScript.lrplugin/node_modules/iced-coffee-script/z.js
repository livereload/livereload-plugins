(function() {
  var delay, foo, iced, multi, __iced_k,
    __slice = [].slice,
  ...
  atest("basic iced waiting", function(cb) {
    var i, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
  ...
  atest("basic iced trigger values", function(cb) {
    var i, j, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    i = 10;
    (function(__iced_k) {
  ...
  atest("basic iced set structs", function(cb) {
    var field, i, obj, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    field = "yo";
    i = 10;
  ...
  atest("defer splats", function(cb) {
    var i, obj, ok, out, v, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    v = [1, 2, 3, 4];
    obj = {
  ...
  atest("continue / break test", function(cb) {
    var i, tot, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    tot = 0;
    (function(__iced_k) {
  ...
  atest("for k,v of obj testing", function(cb) {
    var k, obj, s, v, ___iced_passed_deferral, __iced_deferrals, _k,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    obj = {
      the: "quick",
  ...
  atest("for k,v in arr testing", function(cb) {
    var i, obj, s, v, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    obj = ["the", "quick", "brown"];
    s = "";
  ...
  atest("switch-a-roos", function(cb) {
    var i, res, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    res = 0;
    (function(__iced_k) {
  ...
  atest("parallel awaits with classes", function(cb) {
    var MyClass, obj, v, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    MyClass = (function() {
      ...
      MyClass.prototype.increment = function(wait, i, cb) {
        var ___iced_passed_deferral2, __iced_deferrals,
          _this = this;
  ...
  atest("simple autocb operations", function(cb) {
    var b, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    b = false;
    foo = function(autocb) {
  ...
  atest("AT variable works in an await (1)", function(cb) {
    var MyClass, o, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    MyClass = (function() {
  ...
  atest("more advanced autocb test", function(cb) {
    var bar, oks, x, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    bar = function() {
      return "yoyo";
  ...
  atest("test of autocb in a simple function", function(cb) {
    var ok, simple, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
  ...
  atest("test nested serial/parallel", function(cb) {
    var i, ok, slots, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    slots = [];
    (function(__iced_k) {
  ...
  atest("loops respect autocbs", function(cb) {
    var bar, ok, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    ok = false;
    bar = function(autocb) {
      var i, ___iced_passed_deferral2, __iced_deferrals, _i, _results, _while,
        _this = this;
      __iced_k = autocb;
      ___iced_passed_deferral2 = iced.findDeferral(arguments);
      i = 0;
  ...
  atest("test scoping", function(cb) {
    var MyClass, o, v, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    MyClass = (function() {
      ...
      MyClass.prototype.run = function(autocb) {
        var Inner, i, ___iced_passed_deferral2, __iced_deferrals,
          _this = this;
        __iced_k = autocb;
        ___iced_passed_deferral2 = iced.findDeferral(arguments);
        this.val++;
          ...
          (function(__iced_k) {
            ...
            (function(__iced_k) {
              ...
              (function(__iced_k) {
                ...
                (function(autocb) {
                  var Inner, i, ___iced_passed_deferral3, __iced_deferrals, __iced_k;
                  __iced_k = autocb;
                  ___iced_passed_deferral3 = iced.findDeferral(arguments);
                  Inner = (function() {
                    ...
                    Inner.prototype.chill = function(autocb) {
                      var ___iced_passed_deferral4, __iced_deferrals, __iced_k,
                        _this = this;
                      __iced_k = autocb;
                      ___iced_passed_deferral4 = iced.findDeferral(arguments);
                      (function(__iced_k) {
                        __iced_deferrals = new iced.Deferrals(__iced_k, {
                          parent: ___iced_passed_deferral4,
                          filename: "test/iced.coffee",
                          funcname: "Inner.chill"
                        });
                        delay(__iced_deferrals.defer({
  ...
  atest("AT variable works in an await (2)", function(cb) {
    ...
    MyClass = (function() {
      ...
      MyClass.prototype.run = function(autocb) {
        var i, ___iced_passed_deferral2, __iced_deferrals,
          _this = this;
        __iced_k = autocb;
        ___iced_passed_deferral2 = iced.findDeferral(arguments);
        (function(__iced_k) {
  ...
  atest("fat arrow versus iced", function(cb) {
    var Foo, f, ok1, ok2, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    Foo = (function() {
  ...
  atest("nested loops", function(cb) {
    var i, j, val, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    val = 0;
    (function(__iced_k) {
  ...
  atest("empty autocb", function(cb) {
    var bar, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    bar = function(autocb) {
      autocb();
  ...
  atest("until", function(cb) {
    var i, out, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    i = 10;
    out = 0;
  ...
  atest('expressions -- simple assignment', function(cb) {
    var adder, ret, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    adder = function(x, cb) {
      var ___iced_passed_deferral2, __iced_deferrals,
  ...
  atest('expressions -- simple, but recursive', function(cb) {
    var y, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    return (function(__iced_k) {
      if (true) {
  ...
  atest('expressions -- simple, but recursive (2)', function(cb) {
    var adder, x, y, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    adder = function(x, cb) {
      var ___iced_passed_deferral2, __iced_deferrals,
  ...
  atest('expressions -- pass value of tail calls', function(cb) {
    var adder, y, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    adder = function(x, cb) {
      var ___iced_passed_deferral2, __iced_deferrals,
  ...
  atest('expressions -- addition (1)', function(cb) {
    var slowAdd, y, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
  ...
  atest('expressions - chaining', function(cb) {
    var Img, id, loadImage, x, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    id = "image data";
    Img = (function() {
  ...
  atest('expressions - call args', function(cb) {
    var slowAdd, x, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    slowAdd = function(a, b, autocb) {
      var ___iced_passed_deferral2, __iced_deferrals, __iced_k,
  ...
  atest('arrays and objects', function(cb) {
    var arr, id, loadImage, obj, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    id = "image data";
    loadImage = function(n, cb) {
  ...
  atest('arrays 2', function(cb) {
    var arr, parrot, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
  ...
  atest('nesting', function(cb) {
    var id, loadImage, render, y, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    id = "image data";
    loadImage = function(n, cb) {
  ...
  atest('expressions + loops', function(cb) {
    var i, ok, parrot, v, x, y, z, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    parrot = function(n, cb) {
      var ___iced_passed_deferral2, __iced_deferrals,
  ...
  atest('expressions + loops', function(cb) {
    var eat, food, lunch, ok, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
  ...
  atest('expressions + ops + if', function(cb) {
    var parrot, y, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    parrot = function(n, cb) {
      var ___iced_passed_deferral2, __iced_deferrals,
  ...
  atest('super with no args', function(cb) {
    var A, P, a, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    return cb(true, {});
    P = (function() {
    ...
    A = (function(_super) {
      ...
      function A() {
        A.__super__.constructor.apply(this, _arguments);
      }
  ...
  atest('nested for .. of .. loops', function(cb) {
    var first, info, k, tot, v, x, ___iced_passed_deferral, __iced_deferrals, _k, _l,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    x = {
      christian: {
    ...
    (function(__iced_k) {
      ...
      _while = function(__iced_k) {
        ...
        if (!(_i < _keys.length)) {
          ...
          tot += info.age;
          (function(__iced_k) {
            var _j, _keys2, _l, _ref2, _results2, _while;
            _ref2 = info;
            _keys2 = (function() {
              var _results3;
              _results3 = [];
  ...
  atest('for + return + autocb', function(cb) {
    var bar, v, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    bar = function(autocb) {
      var i, ___iced_passed_deferral2, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = autocb;
      ___iced_passed_deferral2 = iced.findDeferral(arguments);
      (function(__iced_k) {
  ...
  atest('for + return + autocb (part 2)', function(cb) {
    ...
    ___iced_passed_deferral = iced.findDeferral(arguments);
    bar = function(autocb) {
      var i, x, ___iced_passed_deferral2, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = autocb;
      ___iced_passed_deferral2 = iced.findDeferral(arguments);
      (function(__iced_k) {
  ...
  atest("for + guards", function(cb) {
    var i, v, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    return (function(__iced_k) {
      var _i, _results, _while;
  ...
  atest("while + guards", function(cb) {
    var i, v, x, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    i = 0;
    return (function(__iced_k) {
  ...
  atest("nested loops + inner break", function(cb) {
    var i, j, res, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    i = 0;
    (function(__iced_k) {
  ...
  atest("defer and object assignment", function(cb) {
    var baz, i, out, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    baz = function(cb) {
      var ___iced_passed_deferral2, __iced_deferrals,
  ...
  atest('defer + arguments', function(cb) {
    var bar, x, ___iced_passed_deferral, __iced_deferrals,
      _this = this;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    bar = function(i, cb) {
      var ___iced_passed_deferral2, __iced_deferrals,
