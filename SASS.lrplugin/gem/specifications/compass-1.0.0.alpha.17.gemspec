# -*- encoding: utf-8 -*-
# stub: compass 1.0.0.alpha.17 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.authors = ["Chris Eppstein", "Scott Davis", "Eric A. Meyer", "Brandon Mathis", "Nico Hagenburger"]
  s.date = "2013-12-11"
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<compass-core>, ["~> 1.0.0.alpha.16"])
      s.add_runtime_dependency(%q<compass-import-once>, ["~> 1.0.1"])
      s.add_runtime_dependency(%q<chunky_png>, ["~> 1.2"])
      s.add_runtime_dependency(%q<listen>, ["~> 1.1.0"])
      s.add_runtime_dependency(%q<json>, [">= 0"])
    else
      s.add_dependency(%q<sass>, ["~> 3.3.0.rc.1"])
      s.add_dependency(%q<compass-core>, ["~> 1.0.0.alpha.16"])
      s.add_dependency(%q<compass-import-once>, ["~> 1.0.1"])
